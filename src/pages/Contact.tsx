              ...
              <div className="form-contact">
                ...
                <div className="row mt-50">
                  ...
                  <div className="col-lg-12">
                    <div className="form-group">
                      <textarea className="form-control bg-gray-850 border-gray-800 color-gray-500" rows={5} placeholder="Message *"/>
                    </div>
                  </div>
                  <div className="col-lg-12">
                    <div className="text-center mb-50"><a className="btn btn-linear btn-load-more btn-radius-8 hover-up">
                        Send Message
